...
class $AssetsOneIconsGen {
  const $AssetsOneIconsGen();

  /// File path: assets/one/icons/home.svg
  SvgGenImage get home => const SvgGenImage('assets/one/icons/home.svg');

  /// File path: assets/one/icons/profile.svg
  SvgGenImage get profile => const SvgGenImage('assets/one/icons/profile.svg');

  /// File path: assets/one/icons/screen_2.svg
  SvgGenImage get screen2 => const SvgGenImage('assets/one/icons/screen_2.svg');

  /// File path: assets/one/icons/screen_3.svg
  SvgGenImage get screen3 => const SvgGenImage('assets/one/icons/screen_3.svg');

  /// List of all assets
  List<SvgGenImage> get values => [home, profile, screen2, screen3];
}

class $AssetsOneImagesGen {
  ...
  /// File path: assets/one/images/bg2.png
...
class $AssetsSharedIconsGen {
  const $AssetsSharedIconsGen();

  /// File path: assets/shared/icons/apple.svg
  ...
  /// File path: assets/shared/icons/check.svg
  ...
  /// File path: assets/shared/icons/edit.svg
  SvgGenImage get edit => const SvgGenImage('assets/shared/icons/edit.svg');

  /// File path: assets/shared/icons/email.svg
...
class $AssetsTwoIconsGen {
  const $AssetsTwoIconsGen();

  /// File path: assets/two/icons/home.svg
  SvgGenImage get home => const SvgGenImage('assets/two/icons/home.svg');

  /// File path: assets/two/icons/profile.svg
  SvgGenImage get profile => const SvgGenImage('assets/two/icons/profile.svg');

  /// File path: assets/two/icons/screen_2.svg
...
class $AssetsTwoImagesGen {
  const $AssetsTwoImagesGen();

  /// File path: assets/two/images/logo.png
  AssetGenImage get logo => const AssetGenImage('assets/two/images/logo.png');
...
class Assets {
  ...
  static const $AssetsOneGen one = $AssetsOneGen();
  static const $AssetsSharedGen shared = $AssetsSharedGen();
  static const $AssetsTwoGen two = $AssetsTwoGen();
}
